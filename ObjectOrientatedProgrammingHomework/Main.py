...
class Menu_System:
    ...
    def Save_As_Pickle(self,Type):
        ...
        try:
            ...
            if (Type == "Teacher"):
                with open('DataStorage/TeacherDataStorage_Pickle.bin','wb') as Data:
                    pickle.dump(Teacher.List_Teachers,Data)
            elif (Type == "Student"):
                with open('DataStorage/StudentDataStorage_Pickle.bin','wb') as Data:
                    pickle.dump(Sixth_Form_Student.List_Students,Data)
            elif (Type == "Principle"):
                with open('DataStorage/PrincipleDataStorage_Pickle.bin','wb') as Data:
                    pickle.dump(Principle.PrincipleList)
            Success = True
    ...
    def Get_From_Pickle(self):
        ...
        Success = None
        try:
            with open('DataStorage/TeacherDataStorage_Pickle.bin','rb') as Teacher_Data_File:
                Teacher_Data = pickle.load(Teacher_Data_File)
            with open('DataStorage/StudentDataStorage_Pickle.bin','rb') as Student_Data_File:
                Student_Data = pickle.load(Student_Data_File)
            with open('DataStorage/PrincipleDataStorage_Pickle.bin','rb') as Principle_Data_File:
    ...
    def Menu(self):
        ...
        #the subject would be found within the class variable.
            ...
            for ClassValue in Teacher.List_Teachers:
                for Subject in ClassValue.Subjects_Taught:
                    if (Subject == Subject_Input):
                        People_In_Subjects.append(ClassValue.Name)
            ...
            for Names in People_In_Subjects:
                print(f'{Names} - {Subject_Input}')
